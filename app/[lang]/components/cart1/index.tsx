...
export default function Cart1Component(props: { t: I18N }) {
    ...
    return (
        <>
            <div className="card col-span-12 lg:col-span-3 lg:row-span-4 group">
                <div className="flex w-full h-full">
                    <div className="flex flex-col justify-between gap-4">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-normal gap-4">
                            <a href="https://www.linkedin.com/in/rial-rova/" target="_blank" className="socialButton hover:text-linkedin" id="linkedin" aria-label="Linkedin">
                            ...
                            <a href="https://github.com/manghidev" target="_blank" className="socialButton hover:text-github" id="github" aria-label="GitHub">
                            ...
                            <a href="https://instagram.com/manghi.dev" target="_blank" className="socialButton hover:text-instagram" id="instagram" aria-label="Instagram">
                            ...
                            <a href="https://x.com/manghidev" target="_blank" className="socialButton hover:text-x" id="x" aria-label="Twitter/X">
                            ...
                            <a href="https://t.me/manghidev" target="_blank" className="socialButton hover:text-telegram" id="telegram" aria-label="Telegram">
                            ...
                            <a href="mailto:contact@manghi.dev" className="socialButton hover:text-mail" id="mail" aria-label="Mail">
